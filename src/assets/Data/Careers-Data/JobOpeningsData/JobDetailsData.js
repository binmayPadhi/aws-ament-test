const jobDetailsData = [

    {
        ...
        and ambition to develop & complete projects to the highest standard and want to be part of an organization that 
        puts technology at the heart of everything it does. Candidates with 4 to 8 years of experience in MEAN Stack 
        software development will be considered.`,
        responsibilities : "Your Key Responsibilities",
        responsibilitiesList: [
            {
                id : 48,
                list : "Must be able to develop state of art Angular applications using RESTful micro services, Node.js and MongoDB Stack."
            },
            {
                id : 49,
                list : "Implementation of security and data protection."
            },
            {
                id : 50,
                list : "Implementation of robust set of services / APIs to power the web application."
            },
            {
                id : 51,
                list : "Building reusable code and libraries for future use."
            },
            {
                id : 52,
                list : "Optimisation of the application for maximum speed and scalability."
            },
            {
                id : 53,
                list : "Integration of the front-end and back-end aspects of the web application."
            },
            {
                id : 54,
        ...
        toBringLists: [
            {
                id : 61,
                list : "3+ years’ experience with Angular, version 6.0 and above."
            },
            {
                id : 62,
                list : "3+ years’ experience with Node Js."
            },
            {
                id : 63,
                list : "Expertise in JavaScript, Typescript, Angular, NodeJS."
            },
            {
                id : 64,
                list : "Good understanding of OOPs."
            },
            {
                id : 65,
                list : "Experience in implementing complex Angular applications using Material UI."
            },
            {
                id : 66,
                list : "Expertise with HTML5, CSS3, and writing cross-browser compatible code."
            },
            {
                id : 67,
                list : "Strong Experience in implementing RESTful services."
            },
            {
                id : 68,
                list : "Strong understanding of SQL and writing queries."
            },
            {
                id : 69,
                list : "Experience with noSql and MongoDB."
            },
            {
                id : 70,
                list : "Experience in JavaScript build tools like grunt, gulp."
            },
            {
                id : 71,
                list : "Experience in testing frameworks (Ex. protractor, jasmine, etc)."
            },
            {
                id : 72,
                list : "Experience with deploying with Docker."
            },
            {
                id : 73,
                list : "Critical thinker and problem-solving skill."
            }
        ]
    },
    ...
    
    {
        ...
        predictive models to extract the data the business needs, and help analyze the data.`,
        responsibilities : "Your Key Responsibilities",
        responsibilitiesList: [
            {
                id : 74,
                list : "Identify valuable data sources and automate collection processes."
            },
            {
                id : 75,
                list : "Undertake preprocessing of structured and unstructured data."
            },
            {
                id : 76,
                list : "Analyze large amounts of information to discover trends and patterns."
            },
            {
                id : 77,
                list : "Build predictive models and machine-learning algorithms."
            },
            {
                id : 78,
                list : "Combine models through ensemble modeling."
            },
            {
                id : 79,
                list : "Present information using data visualization techniques."
            },
            {
                id : 80,
                list : "Propose solutions and strategies to business challenges."
            },
            {
                id : 81,
                list : "Collaborate with engineering and product development teams."
            }
        ],
        toBring : "What To Bring",
        toBringLists: [
            {
                id : 82,
                list : "Proven experience as a Data Scientist or Data Analyst."
            },
            {
                id : 83,
                list : "Experience in data mining."
            },
            {
                id : 84,
                list : "Understanding of machine-learning and operations research."
            },
            {
                id : 85,
                list : "Knowledge of R, SQL and Python; familiarity with Scala, Java or C++ is an asset."
            },
            {
                id : 86,
                list : "Experience using business intelligence tools (e.g. Tableau) and data frameworks (e.g. Hadoop)."
            },
            {
                id : 87,
                list : "Analytical mind and business acumen."
            },
            {
                id : 88,
                list : "Strong math skills (e.g. statistics, algebra)."
            },
            {
                id : 89,
                list : "Problem-solving aptitude."
            },
            {
                id : 153,
                list : "Excellent communication and presentation skills."
            }
        ]
    },
...

    {
        ...
        media. A self-starter, capable of delivering creative ideas and showing amazing attention to detail will be preferred.`,
        responsibilities : "Your Key Responsibilities",
        responsibilitiesList: [
            {
                id : 125,
                list : "Come up with highly engaging designs which are in accordance with the brand attributes."
            },
            {
                id : 126,
                list : "Knowledge of typography, colour, iconography, layouts and visual hierarchy to deliver high quality digital and print media."
            },
            {
                id : 127,
                list : "Close interaction with the marketing and leadership team to analyse and understand the requirements."
            },
            {
                id : 128,
                list : "Plan and design concepts by researching on the topics based on the requirements and convert them into final artwork that can be used across various digital and offline platforms."
            }
        ],
        toBring : "What To Bring",
        toBringLists: [
            {
                id : 129,
                list : "A bachelor’s degree or equivalent experience in the graphic design field."
            },
            {
                id : 130,
                list : "A portfolio (online preferred) displaying illustrations and other graphics."
            },
            {
                id : 131,
                list : "Working knowledge with design software’s like Adobe Illustrator, Adobe Xd and Adobe Photoshop."
            },
            {
                id : 132,
                list : "Knowledge on web design will be an added advantage."
            },
            {
                id : 133,
...

    {
        ...
        the Product Lifecycle, including gathering and prioritizing product and customer requirements, defining 
        the product vision, and working closely with engineering, sales, marketing and support to ensure revenue 
        and customer satisfaction goals are met. The Product Managers job also includes ensuring that the product 
        supports the companys overall strategy and goals.
        The person should be very flexible in terms of working as per different time zone to meet solution 
        delivery timeline. The person should be open to learn and adopt various technologies coming in the 
        field of Automation & AI and keep himself proactively updated.`,
        responsibilities : "Your Key Responsibilities",
        responsibilitiesList: [
            {
                id : 135,
                list : "Define the product strategy and roadmap."
            },
            {
                id : 136,
                list : "Accountable to understand the business requirement from Sales, BA , customer and transform them from non-technical requirement to technical requirement."
            },
            {
                id : 137,
                list : "Deliver MRDs and PRDs with prioritized features and corresponding justification."
            },
            {
                id : 138,
                list : "Work with external third parties to assess partnerships and licensing opportunities."
            },
            {
                id : 139,
                list : "Run beta and pilot programs with early-stage products and samples."
            },
            {
                id : 140,
                list : "Be an expert with respect to the competition and act as a go-to person within the company."
            }
        ],
        toBring : "What To Bring",
        toBringLists: [
            {
                id : 141,
                list : "Minimum of 13 years experience, with at least 5 year as a Product Manager."
            },
            {
                id : 142,
                list : "Demonstrated success defining and launching excellent products."
            },
            {
                id : 143,
                list : "5+ years of experience in a job in the Global market."
            },
            {
                id : 144,
                list : "Excellent written and verbal communication skills."
            },
            {
                id : 145,
                list : "Bachelor’s degree (MBA preferred)."
            },
            {
                id : 146,
                list : "Software Development/BA Background with experience in IT products and service."
            },
            {
                id : 147,
                list : "Deep Understanding of product road map."
            },
            {
                id : 148,
                list : "Excellent teamwork skills."
            },
            {
                id : 149,
                list : "Proven ability to influence cross-functional teams without formal authority."
            },
            {
                id : 150,
                list : "Examples and at least one sample of an effective document delivered in the past."
            },
            {
                id : 151,
                list : "Excellent communication & presentation skill is highly required."
            },
            {
                id : 152,
