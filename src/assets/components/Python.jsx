            ...
            <div className="w-90 mx-auto py-2">
              ...
              <div className="">
                ...
                <p className="fs-16 fw-bold-400">
                  {" "}
                  The role of a Python developer is to contribute to coding done
                  using Python language in different areas of web development,
                  application development, game development, data science,
                ...
                <p>
                  <ul className="career-details bg">
                    ...
                    <li className="fs-16 fw-bold-400 ">
                      Understanding, analyzing, and implementing – Business
                      needs, feature modification requests, conversion into
                      software components.
                    </li>
                    <li className="fs-16 fw-bold-400 ">
                      Integration of user-oriented elements into different
                      applications, data storage solutions.
                    </li>
                    <li className="fs-16 fw-bold-400 ">
                      Developing – Backend components to enhance performance and
                      receptiveness, server-side logic, and platform,
                      statistical learning models, highly responsive web
                      applications.
                    </li>
                    <li className="fs-16 fw-bold-400">
                      Designing and implementing – High availability and low
                      latency applications, data protection and security
                      features.
                    </li>
                    <li className="fs-16 fw-bold-400">
                    ...
                    <li className="fs-16 fw-bold-400">
                      Testing and debugging software applications with Python
                      test framework tools like Behave, Pytest, PyUnit, etc.
                    </li>
                    <li className="fs-16 fw-bold-400">
                      Enhancing the functionalities of current software systems.
                    </li>
                    <li className="fs-16 fw-bold-400">
                      Coming up with digital tools for online traffic
                      monitoring.
                    </li>
                    <li className="fs-16 fw-bold-400">
                    ...
                    <li className="fs-16 fw-bold-400">
                      Fine-tune and develop AI/ML-based algorithms based on
                      results.
                    </li>
                  </ul>
                </p>
                ...
                <ul className="career-details bg">
                  <li className="fs-16 fw-bold-400">
                    {" "}
                    4 - 8 years of hand on experience of developing python-based
                    solutions/applications.
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Strong experience in Python, preferably with a good low
                    level designing and programming concepts.
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Strong experience in any cloud platform preferably AWS or
                    GCP. 
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Strong experience of working with API’s and integrating
                    multiple applications together.
                  </li>
                  <li className="fs-16 fw-bold-400">
                  ...
                  <li className="fs-16 fw-bold-400">
                    Excellent understanding of OOP concepts with experience
                    applying it in enterprise programming.
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Deep understanding of distributed systems (e.g. CAP theorem,
                    partitioning, replication, consistency, and consensus)
                  </li>
                  <li className="fs-16 fw-bold-400">
                  ...
                  <li className="fs-16 fw-bold-400">
                    Experience of working with Data Warehousing Technologies
                    like BigQuery, Redshift, or snowflake is a plus.
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Experience in using Business Intelligence tools such as:
                    Tableau, Power BI for business applications is a plus.
                  </li>
                  <li className="fs-16 fw-bold-400">
                  ...
                  <li className="fs-16 fw-bold-400">
                    Flexibility to adapt to a variety of engagement types,
                    working hours and work environments and locations.
                  </li>
                </ul>
              </div>
            </div>
