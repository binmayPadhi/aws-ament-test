            ...
            <div className="w-90 mx-auto py-2">
              ...
              <div className="">
                ...
                <p className="fs-16 fw-bold-400">
                  {" "}
                  Providing development guidance to developers and peers with
                  ability to triage and assign work. Provide high quality
                  application engineering deliverables in accordance with the
                  project timelines. Participation and possible facilitation of
                  stand ups, grooming, sprint planning, task estimation and
                  sprint retrospectives. Regular interaction with Product
                  Owners/BAs to understand business requirements and help with
                  story /task definition and prioritization. Coordinating with
                  the deployment team to push the completed tasks to higher
                  environments. Mentoring the junior Associate Developers and
                ...
                <p>
                  <ul className="career-details bg">
                    ...
                    <li className="fs-16 fw-bold-400">
                      Can produce well-organized, optimized and documented
                      source code.
                    </li>
                    <li className="fs-16 fw-bold-400">
                    ...
                    <li className="fs-16 fw-bold-400">
                      Attention to detail is essential and all tasks must be
                      carried out to the highest standard.
                    </li>
                    <li className="fs-16 fw-bold-400">
                      Coordinate with other programmers to design and implement
                      features.
                    </li>
                    <li className="fs-16 fw-bold-400">
                      Become a part of a state-of-the-art offshore Centre of a
                      global operating organization.
                    </li>
                    <li className="fs-16 fw-bold-400">
                      Participate in building high class products for our
                      customers and profit from the motivating and employee
                      friendly environment in our organization.
                    </li>
                  </ul>
                </p>
                ...
                <ul className="career-details bg">
                  ...
                  <li className="fs-16 fw-bold-400">
                    Excellent technical hands-on experience on .Net Core, Web
                    Api and Sql Server.
                  </li>
                  <li className="fs-16 fw-bold-400">
                  ...
                  <li className="fs-16 fw-bold-400">
                    Good knowledge on Asp.Net MVC, ADO.Net and Entity Framework.
                  </li>
                  <li className="fs-16 fw-bold-400">
                  ...
                  <li className="fs-16 fw-bold-400">
                    Good team player and excellent individual contributor
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Knowledge on any of the architectural design pattern
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Good experience in developing platforms. (.Net/ .NET Core )
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Excellent hands-on experience in ASP.Net, ASP.Net MVC,
                    ASP.Net Core
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Participating in full stack development
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Adhere to application engineering methodologies, coding
                    standards, code reviews.
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Providing feedback regarding application engineering
                    methodologies, standards, and leading practices when
                    appropriate
                  </li>
                  <li className="fs-16 fw-bold-400">
                    Collaborating with other development teams for integrations
                    and deployment
                  </li>
                </ul>
              </div>
