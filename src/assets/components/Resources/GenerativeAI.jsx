...
import CTAIMG from "../../images/Resources-page/CTA-10.png";
                ...
                <div className="center">
                    <div className="new-home-about-details row ml-0 mr-0 above-spacings">
                        <div className="col-12 pl-0 pr-0 mb-5">
                            <h1 >
                                10 ways how Generative AI has a positive impact on Retail organizations
                            </h1>
                        </div>
                    </div>
                            ...
                            return (
                                <div className="col-12  p-0" key={list.id}>
                                    ...
                                    <p className="fs-18 ">
                                        ...
                                        <span className="fs-18 fw-bold font-weight-bold" >{list.description22}</span>
