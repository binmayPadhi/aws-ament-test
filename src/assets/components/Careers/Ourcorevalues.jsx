    ...
    return(
        <>
         <div className="w-90 mx-auto ">
          <div className="mt-5">
        <img alt="" src={openquotes} loading="lazy" />
        <p className="fs-24 fw-bold-500 text-green">
         ...
         <sub><img alt=" " src={closedquotes} className="margin-closedquotes pt-4" loading="lazy" /></sub> 
        </p>
        <hr className="hr-separation" />  
        <div className="w-100 mx-auto mt-5"> 
        <div className="row ml-1">
        <div className="col-lg-3 col-md-2 col-sm-12 d-flex flex-row">
          <img src={vara} className="vara-img" loading="lazy" />      
