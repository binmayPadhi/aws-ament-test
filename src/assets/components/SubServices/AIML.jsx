    ...
    return (
        ...
        {console.log(match)}
                ...
                {SubServicesData.filter(data => data.id == match.params.id).map(serviceDetail => {
                    return (
                        <>
                         <div className="sub-service-intro container-fluid" style={{backgroundImage:`url(${serviceDetail.BG})`,backgroundAttachment:"scroll",backgroundRepeat:"no-repeat",backgroundSize:"cover"}}>
